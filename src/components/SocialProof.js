  ...
  return (
    <section id="proof" style={{ background: '#0E1A24', color: '#fff' }}>
      <div style={{ maxWidth: 1320, margin: '0 auto', padding: '100px 32px', textAlign: 'center' }}>
        ...
        <h2 style={{ fontFamily: "'Plus Jakarta Sans',sans-serif", fontWeight: 800, fontSize: 42, letterSpacing: '-.02em', lineHeight: 1.15, maxWidth: 720, margin: '0 auto 48px' }}>Early results from the players and coaches using Kibitzz</h2>
